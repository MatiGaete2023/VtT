...
3. Toca **Seleccionar audio** y escoge un archivo (mp3, m4a, wav, ogg, mp4…).
4. Toca **Transcribir**.
   - La **primera vez con cada modelo** se descarga el modelo (necesita internet).
   - Después transcribe **offline**.
5. **Copia** o **comparte** el texto resultante.
...
- Puente JNI: `app/src/main/cpp/whisper_jni.cpp` ↔ `WhisperBridge.kt`.
